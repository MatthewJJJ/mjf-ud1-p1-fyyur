...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\dev-code\udacity-full-stack-dev-nd\mjf-ud1-p1-fyyur\env'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\dev-code\udacity-full-stack-dev-nd\mjf-ud1-p1-fyyur\env\Scripts\deactivate.nu'
