...
# TODO Implement Show and Artist models, and complete all model relationships and properties, as a database migration. - COMPLETE
# Filters.
...
def create_venue_submission():
  # TODO: Come back and do some form validations
  try: 
    new_venue = Venue(
      ...
      talent = True, # TODO: Fix Boolean logic
...
def create_artist_submission():
  ...
  try: 
    new_artist = Artist(
      ...
      facebook_link = request.form['facebook_link'],
      description = request.form['seeking_description'],
      looking_for_venue = True # implement boolean logic
    )
